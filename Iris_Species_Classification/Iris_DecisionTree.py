...
# About:  Implementing Decision Tree Classifier model to predict Iris Species.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
if __name__ == "__main__":
	print("------------------------- Machine Learning Application of Iris Prediction using Decision Tree Classifier -------------------------")
	main()
