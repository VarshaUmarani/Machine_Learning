...
# About:  Implementing Random forest classifier model to predict the breast cancer.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
if __name__ == "__main__":
	print("------------------------- Machine Learning Application of Breast Cancer Prediction using Random Forest -------------------------")
	main()
