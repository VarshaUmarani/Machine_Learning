...
# About:  Implementing Bagging Classifier model for MNIST
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
def bagging_classifier(features, target):
	"""
	To train the Bagging Classifier with features and target data
	:param features:
	:param target:
	:return: trained instance of Bagging Classifier
	"""
...
def main():
	...
	trained_model = bagging_classifier(train_x, train_y)
...
if __name__ == "__main__":
	print("------------------------- Machine Learning Application of MNIST using Bagging Classifier -------------------------")
	main()
