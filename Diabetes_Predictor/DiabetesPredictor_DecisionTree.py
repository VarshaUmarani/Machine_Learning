...
# About:  Implementing Decision Tree Classifier model for Diabetes Predictor
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
if __name__ == "__main__":
	print("------------------------- Machine Learning Application of Diabetes Prediction using Decision Tree Classifier -------------------------")
	main()
